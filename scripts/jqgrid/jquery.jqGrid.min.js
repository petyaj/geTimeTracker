...
0===h&&(h=""),h=j(h,c),l.push({vSort:h,index:a})}),$.isFunction(f)?l.sort(function(a,b){return f.call(this,a.vSort,b.vSort,m,a,b)}):l.sort(function(a,b){if(self._compare(a.vSort,b.vSort,m)===0&&(a.vSort==="запросы"||b.vSort==="запросы")){return a.index - b.index;}return self._compare(a.vSort,b.vSort,m)}),i=0;for(var
...
match=_query,results=[];return null===match?self:($.each(_data,function(){debugger;match&&results.push(this)}),_data=results,self)},this.data=function(){return _data},this.select=function(a){if(self._performSort(),!self._hasData())return[];if(self.execute(),$.isFunction(a)){var
...
b,c,e=[],f=0;for(c=0;c<d.p.colModel.length;c++)b=d.p.colModel[c],"cb"!==b.name&&"subgrid"!==b.name&&"rn"!==b.name&&(e[f]="local"===a?b.jsonmap||b.name:"xml"===a||"xmlstring"===a?b.xmlmap||b.name:b.jsonmap||b.name,d.p.keyName!==!1&&b.key===!0&&(d.p.keyName=e[f]),f++);return e},H=function(a){var
...
0===x&&(x=W+o,0===C.length&&g.cell))){debugger;var
...
e=c.target;if("TEXTAREA"===e.tagName&&!c.ctrlKey)return!0;if(a(i).jqGrid("saveRow",b,k)&&i.p.inlineNav)try{a(i).jqGrid("showAddEditButtons")}catch(f){}return!1}}),a(i).triggerHandler("jqGridInlineEditRow",[b,k]),a.isFunction(k.oneditfunc)&&k.oneditfunc.call(i,b)))}})},saveRow:function(b,c,d,e,f,g,h){var
